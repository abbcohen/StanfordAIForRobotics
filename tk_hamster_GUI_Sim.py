...
class virtual_world:
    ...
    def draw_map(self):
        ...
        for rect in self.map:
            ...
            # self.canvas.create_rectangle([x1-28,y1+28,x2+28,y2-28], outline="red")
        ...
        for cobs in self.cobs:
            ...
            bottomLeft=[x1,y2]
            bottomRight=[x2,y2]
            # self.canvas.create_line(topLeft[0], topLeft[1], topLeft[0], 0)
            # self.canvas.create_line(topRight[0], topRight[1], topRight[0], 0)
            # self.canvas.create_line(bottomLeft[0], bottomLeft[1], bottomLeft[0], canvas_height*2)
            # self.canvas.create_line(bottomRight[0], bottomRight[1], bottomRight[0], canvas_height*2)
            self.canvas.create_oval(topLeft[0]-4, topLeft[1]-4, topLeft[0]+4, topLeft[1]+4, outline = "green")
            self.canvas.create_oval(topRight[0]-4, topRight[1]-4, topRight[0]+4, topRight[1]+4, outline = "green")
            self.canvas.create_oval(bottomLeft[0]-4, bottomLeft[1]-4, bottomLeft[0]+4, bottomLeft[1]+4, outline = "green")
            self.canvas.create_oval(bottomRight[0]-4, bottomRight[1]-4, bottomRight[0]+4, bottomRight[1]+4, outline = "green")
